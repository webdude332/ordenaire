...
// import BillingActionsModal from '@/components/Modals/BillingActionsModal';
// import ContactModal from '@/components/Modals/ContactModal';
// import DownloadInvoiceModal from '@/components/Modals/DownloadModal';
// import EditPlanModal from '@/components/Modals/EditPlanModal';
// import ForceUninstallModal from '@/components/Modals/ForceUninstallModal';
...
//     const [isForceUninstallModalOpen, setIsForceUninstallModalOpen] =
//         useState(false);
...
//     // Billing Actions Modal state
//     const [isBillingActionsOpen, setIsBillingActionsOpen] = useState(false);
//     const [selectedBreakdownItem, setSelectedBreakdownItem] = useState<
//         (typeof breakdownData)[0] | null
//     >(null);
...
//             },
//             billing: { currency: '5.000 KWD', subCurrency: '45.000 AED' },
//             cycle: 'Monthly',
...
//         {
//             id: 2,
//             app: { appname: 'Employee status', appby: 'Ordenaire' },
//             billing: { currency: '5.000 KWD', subCurrency: '45.000 AED' },
//             cycle: 'Monthly',
//             installDate: '12 Aug 2025',
//             status: 'Active',
...
//         {
//             id: 1,
//             resource: { title: 'Active Staff', limit: 'Limit: 5 Users' },
//             usage: '7',
//             justification: {
...
//             },
//             status: 'Invoiced',
//             currency: { main: '4.000 KWD', sub: '50.000 AED' },
//         },
//         {
//             id: 2,
//             resource: { title: 'Menu Items', limit: 'Limit: 150 Items' },
//             usage: '112',
//             justification: { main: '+3 Extra Items', date: 'Detected: 01 Jan' },
//             status: 'Resolved',
//             currency: { main: '0.000 KWD', sub: '0.000 AED' },
//         },
//         {
//             id: 3,
//             resource: { title: 'Kiosk Machines', limit: 'Limit: 0 (Add-on)' },
//             usage: '2',
//             justification: { main: '1 Device', date: 'Purchased: 02 Jan' },
//             status: 'One-Time',
//             currency: { main: '100.000 KWD', sub: '950.000 AED' },
//         },
//         {
//             id: 4,
//             resource: { title: 'Storage', limit: 'Limit: 10 GB' },
//             usage: '2.1',
//             justification: {
//                 main: '12 GB (Limit: 10)',
...
//     // Build the item object that BillingActionsModal expects
//     const buildBillingActionItem = (item: (typeof breakdownData)[0]) => ({
//         businessName: 'PizzaPalace',
//         busId: 'BIZ-2050',
//         currentPlan: 'Pro (Monthly)',
//         chargeRule: item.resource.title,
//         description: item.justification.main,
//         date: item.justification.date
//             .replace('Detected: ', '')
//             .replace('Purchased: ', ''),
//         originalAmount: parseFloat(item.currency.main) || 0,
//         currency: 'KWD',
//     });
...
//                                             {/* ── ACTION BUTTON: opens BillingActionsModal ── */}
...
//             {/* ── Force Uninstall Modal ───────────────────────────────────── */}
//             <ForceUninstallModal
//                 isOpen={isForceUninstallModalOpen}
//                 onClose={() => setIsForceUninstallModalOpen(false)}
//                 onConfirm={() => setIsForceUninstallModalOpen(false)}
//                 businessName={selectedItem?.app.appname}
//                 businessId="BIZ-2050"
//                 appName={selectedItem?.app.appname}
//                 appProvider={selectedItem?.app.appby}
//                 AppIcon={selectedItem?.AppIcon}
...
//             {isBillingActionsOpen && selectedBreakdownItem && (
//                 <BillingActionsModal
...
//                         handleResend(
//                             'Charge Initiated',
//                             `Charge of ${data.finalAmount} KWD submitted for ${selectedBreakdownItem.resource.title}.`,
//                         );
//                         setIsBillingActionsOpen(false);
//                         setSelectedBreakdownItem(null);
//                     }}
//                     item={buildBillingActionItem(selectedBreakdownItem)}
//                 />
//             )}
//         </div>
//     );
...
// ─── PortaledSubMenu ──────────────────────────────────────────────────────────
// Renders SubMenu at document.body via portal so it escapes any overflow:hidden
// parent — fixes rounded-corner clipping without hiding the dropdown.
interface PortaledSubMenuProps {
    top: number;
    right: number;
...
function PortaledSubMenu({ top, right, items, onClose }: PortaledSubMenuProps) {
    return createPortal(
...
export default function SubscriptionDetail() {
    ...
    // Portaled menu state — replaces isSubMenuOpen + openBillingMenuId
    const [addonsMenu, setAddonsMenu] = useState<OpenMenu | null>(null);
    const [billingMenu, setBillingMenu] = useState<OpenMenu | null>(null);
        ...
        <div className="flex min-h-screen">
            ...
            <main className="flex flex-1 flex-col">
                ...
                <div className="flex-1 px-8">
                    ...
                    {/* ── Installed Apps & Add-ons ─────────────────────────────── */}
                    {/* overflow-hidden clips the table to the rounded corners.     */}
                    {/* The SubMenu is portaled so it still appears above everything */}
            ...
            {/* ── Portaled SubMenus ───────────────────────────────────────────
                Rendered at document.body so overflow:hidden on section wrappers
                never clips them. Positioned with fixed coords from getBoundingClientRect.
            ─────────────────────────────────────────────────────────────────── */}
            {addonsMenu && (
                <PortaledSubMenu
                    top={addonsMenu.top}
                    right={addonsMenu.right}
                    items={addonsMenu.items}
                    onClose={() => setAddonsMenu(null)}
                />
            )}
            {billingMenu && (
                <PortaledSubMenu
                    top={billingMenu.top}
                    right={billingMenu.right}
                    items={billingMenu.items}
                    onClose={() => setBillingMenu(null)}
                />
            )}
