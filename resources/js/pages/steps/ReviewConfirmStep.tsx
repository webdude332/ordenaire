        ...
        <div>
            <div className="space-y-8 pt-6">
                ...
                <div className="flex items-center justify-end gap-3 border-t border-gray-200 bg-white px-8 py-4">
                    ...
                    <Button onClick={handleConfirmClick} className='cursor-pointer'>
                        Confirm & Create Business
                    </Button>
                </div>
            </div>
            ...
            {showSuccessModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50 backdrop-blur-sm transition-opacity">
                    <div className="relative w-full max-w-2xl transform rounded-xl bg-white p-6 shadow-xl transition-all sm:p-8">
                        ...
                        {/* Top Left Icon */}
                        <div className="absolute left-6 top-6 flex h-10 w-10 items-center justify-center rounded-lg border border-gray-200 bg-white shadow-sm">
                        ...
                        <div className="mt-8 flex flex-col items-center justify-center">
                            ...
                            <p className="mt-2 text-center text-sm text-gray-500 px-4">
                                The business profile has been created successfully and invitation emails have been sent to the team members.
                            </p>

                            {/* Navigation Button */}
                            <button
                                onClick={handleGoToDashboard}
                                className="mt-8 w-full rounded-lg border border-gray-300 bg-white py-2.5 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#8CDD05] focus:ring-offset-2"
                            >
                                Go to Dashboard
                            </button>
                        </div>
