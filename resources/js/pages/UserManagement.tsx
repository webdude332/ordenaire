...
//                 {/* TOP BAR */}
//                 <NewTopBar activeTab={activeTab} onTabChange={setActiveTab} />
...
//                                         {/* Export Button */}
//                                         <button className="inset-shadow-sm-[#0A0D120D] flex items-center gap-2 rounded-lg border border-[#CFCBD2] bg-white px-3 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50">
//                                             <img
//                                                 src={exportIcon}
//                                                 alt="Export"
//                                                 className="h-4 w-4"
...
//                                                     <td className="px-6 py-4 whitespace-nowrap">
//                                                         <span
//                                                             className={`inline-flex items-center gap-1.5 rounded-full border px-2 py-1 text-xs leading-5 font-semibold ${
//                                                                 user.status ===
//                                                                 'Active'
//                                                                     ? 'border-[#ABEFC6] bg-[#ECFDF3] text-green-700'
//                                                                     : 'border-[#E8E6EA] bg-[#F9F7FA] text-gray-600'
//                                                             }`}
//                                                         >
//                                                             <span
...
export default function UserManagement() {
    ...
    // Dynamic Title and Breadcrumbs based on your 'NewTopBar' logic
