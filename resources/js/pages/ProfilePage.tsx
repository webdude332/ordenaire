...
// const ProfilePage = () => {
//     // State for TopBar tabs (visual only)
...
//         {/* MATCHING THE NOAH PIERRE IMAGE */}
//     </div>
//             <div className="mt-8 mx-1 rounded-xl border border-[#E8E6EA] bg-[#F8FFEB] px-6 pb-6 pt-6">
...
//                             Quick Stats
//                         </h3>
//                         <div className="flex w-full items-start divide-x divide-[#E8E6EA] rounded-xl border border-[#E8E6EA] bg-white shadow-xs">
//                             {/* Column 1 */}
...
//                                 Documents
//                             </h3>
//                             <button className="flex items-center gap-2 rounded-lg border border-gray-400 px-3 font-medium py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50">
...
//                         {/* Add Button */}
//                         <button className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
//                             Add to Note
//                         </button>
//                     </div>
//                 </div>
            ...
            <main className="flex flex-1 flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-8 py-6">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex w-full items-start divide-x divide-[#E8E6EA] rounded-xl border border-[#E8E6EA] bg-white shadow-xs py-6">
                            {/* Column 1 */}
                            <div className="flex-1 px-8 py-6">
                                <p className="mb-2 text-sm text-[#696969]">
                                    Tickets Solved (This month)
