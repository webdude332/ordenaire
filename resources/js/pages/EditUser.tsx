...
// import userIcon from '../images/icons/users-edit.png'
...
//         { label: 'Add User', isActive: true }, // Changed 'View' to 'Add User'
//     ];
// const tabs: any[] = [];
...
//                     tabs={tabs} // Passing empty array hides the tab section
//                 >
//                     {/* You can add right-side buttons here if needed */}
//                 </TopBar>
...
const AddUser = () => {
    // State is preserved but effectively unused since tabs are empty for this page
    const [activeTab, setActiveTab] = useState<'profiles' | 'roles'>('profiles');
    ...
    // ✅ Defined Tabs (Empty for "Add User" page so the bar is hidden)
    const tabs: any[] = []; 
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <main className="flex-1 flex flex-col">
                ...
                {/* ✅ Top Navigation with Dynamic Props */}
                <TopBar
                    title="User Management"
                    icon={usersIcon}
                    breadcrumbs={breadcrumbs}
