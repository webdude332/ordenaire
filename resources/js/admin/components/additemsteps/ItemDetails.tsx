...
//             // If it's already in the array, remove it (uncheck)
    ...
    return (
        <div className="space-y-8 border-t border-gray-200 pt-8">
                ...
                <div className="col-span-9 space-y-6 rounded-xl border border-gray-200 bg-white px-6 py-6 shadow-sm">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-4 pt-1">
                            ...
                            {/* 3. UPDATED BUTTON: NOW OPENS THE MODAL INSTEAD OF NATIVE FILE INPUT */}
                            <IconButton
                                type="button"
            ...
            <div className="flex items-center justify-end gap-3 border-t border-gray-200 pt-6">
                <IconButton onClick={onBack}>Cancel</IconButton>
                <IconButton
                    // @ts-ignore - Assuming formData is handled higher up or you will define it
                    onClick={() => console.log('Save as Draft', formData)}
                >
                    Save as Draft
                </IconButton>
            ...
            {/* 4. PLACE THE MODAL COMPONENT SAFELY AT THE BOTTOM */}
            {/* <UploadDocumentModal
                ...
                onUpload={() => {
                    ...
                    // Later, we will add the logic here to pass the actual file into your 'update' function.
