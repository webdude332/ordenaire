...
import { useState } from 'react';
import AppsCard, { AppData } from '../AppsCard';
...
import Loyalty from '@/shared/images/icons/loyalty.svg?react';
import PaymentsIcon from '@/shared/images/icons/payments.svg?react';
...
const appsData: AppData[] = [
    ...
    },
    {
        ...
        icon: <Loyalty className="h-16 w-16" />,
        title: 'Customer Loyalty Programs',
        provider: 'Ordinaire',
        description: 'Reward repeat customers with tailored loyalty programs.',
        features: [
    ...
    },
    {
        ...
        icon: <PaymentsIcon className="h-16 w-16" />,
        title: 'Payment Processing',
        provider: 'Ficos',
        description:
            'Allow customers to reserve tables directly from your website with a seamless booking experience. Reduce manual calls, manage...',
