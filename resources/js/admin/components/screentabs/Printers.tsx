...
import AddPrinter from '../modals/AddPrinter';
...
export default function Printers() {
    ...
    const printerData: PrinterRecord[] = [
        {
            id: 1,
            title: 'Hot Kitchen Thermal',
            status: 'Online',
            ...
            port: '9100',
            macAddress: '',
            assignmentValue: 'orders_hot_kitchen',
        },
        {
            id: 2,
            title: 'Kitchen Thermal',
        ...
        },
        {
            ...
            port: '9100',
            macAddress: '',
            assignmentValue: 'customer_receipts',
        },
    ];
    ...
    const [selectedPrinter, setSelectedPrinter] =
        useState<PrinterRecord | null>(null);

    const handleEditClick = (record: PrinterRecord) => {
