...
//             {/* Footer */}
//             <div className="flex gap-4 border-t border-gray-200 px-6 py-5">
//                 <button
//                     onClick={onClose}
//                     className="flex-1 rounded-lg border border-gray-300 bg-white py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50"
//                 >
//                     Cancel
//                 </button>
