...
import type { CouponFormData } from './AddNewCoupon';
...
export default function EditCoupon({
    ...
    // ✅ FIX — bail out early before any hook reads initialData
    ...
    useEffect(() => {
        if (!initialData) return; // ✅ guard inside useEffect
        setCouponName(initialData.couponName);
        setDiscountValue(initialData.discountValue);
        setStartDate(initialData.startDate);
        setEndDate(initialData.endDate);
        setMinimumOrderAmount(initialData.minimumOrderAmount);
        setScope(initialData.scope);
        setEligibleItems(initialData.eligibleItems);
    }, [initialData]);

    // ✅ Return null AFTER all hooks — this is the correct place
