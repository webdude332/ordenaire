    ...
    const handleSave = () => {
        onConfirm({
            ...
            inventoryRule: linkedItem
                ? `${consumptionQty} x ${linkedItem.name}`
                : 'N/A',
        });
        resetForm();
    };
        ...
        <Modal isOpen={isOpen} onClose={handleClose} maxWidth="xl">
            <div className="p-6 sm:p-8">
                ...
                <div className="space-y-6 rounded-xl border border-borderColor bg-white px-4 py-6 shadow-sm">
                    ...
                    {/* Row 2 — Additional Price + Tax (when trackStock ON) or Estimated Cost (when OFF) */}
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            <Label className="mb-1.5 text-sm font-medium text-gray-700">
                                Additional Price{' '}
                    ...
                    {/* ── Track Stock Section (only when global trackStock is ON) ── */}
                    {trackStock && (
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            {/* Right — Link to Inventory Source (only when per-option ON) */}
                            {optionTrackStock && (
                                <div>
                                    <Label className="mb-1.5 text-sm font-medium text-gray-700">
                    ...
                    {/* ── Consumption Rule + Unit Cost (only after item is linked) ── */}
