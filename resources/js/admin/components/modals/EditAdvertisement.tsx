// EditAdvertisement.tsx
// Matches design: images 1 & 2 (Edit-_1.jpg and Edit-_2.jpg)
...
import EditIcon from '@/shared/images/icons/pencilIcon.svg?react'; // pencil / edit icon
...
interface EditAdvertisementProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: (data: EditAdFormData) => void;
    /** Pre-filled data for the ad being edited */
    initialData: EditAdFormData;
}

export interface EditAdFormData {
    mediaFile: File | null;
    mediaPreviewUrl: string | null; // existing image URL from server
    adName: string;
    duration: number;
    startDate: string;
    endDate: string;
...
export default function EditAdvertisement({
    ...
    // Initialise from passed-in data
    ...
    const [mediaPreview, setMediaPreview] = useState<string | null>(
        initialData.mediaPreviewUrl ?? null,
    );
    const [adName, setAdName] = useState(initialData.adName);
    ...
    const [dailyEndTime, setDailyEndTime] = useState(initialData.dailyEndTime);
    const [displayStatus, setDisplayStatus] = useState(
        initialData.displayStatus,
    );
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} maxWidth="xl">
            ...
            <div className="flex gap-3 border-t border-gray-200 px-6 py-5">
                ...
                {/*
                  "Save Changes" is disabled (grayed) in design image 1 (no media uploaded yet).
                  Enable it once adName is filled and media exists.
                */}
                <Button
                    className="w-full"
