...
import MenuLogo from '../../shared/images/icons/menuLogo.svg?react';
...
const MENU_ITEMS = [
    ...
    },
    {
        ...
        badge: 10,
        hasSubmenu: true,
        route: '/admin/screens-and-devices',
    },
    {
        label: 'Accounts',
        icon: adAccounts,
        ...
        >
            ...
            <div
                className={`flex items-center pt-8 pb-4 ${
                    collapsed
                        ? 'justify-center px-2' // Centers the small logo perfectly when collapsed
                        : 'justify-between px-6' // Pushes logo to left, button to right
                }`}
            >
                {/* Logo expanded */}
                {!collapsed && (
                ...
                {collapsed && (
                    <Link href="/admin/dashboard">
                        <MenuLogo className="h-8 w-8 object-contain" />
                    </Link>
                )}
                ...
                {!collapsed && (
                    <button
                        ...
                        className="flex h-10 w-10 flex-shrink-0 cursor-pointer items-center justify-center rounded-lg border border-gray-200 bg-white shadow-sm transition-colors hover:bg-gray-100"
                        aria-label="Collapse sidebar"
                    >
                        <AdMenuClose className="h-6 w-6" />
                    </button>
                )}
            </div>
