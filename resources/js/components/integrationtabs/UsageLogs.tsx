...
// import trendIcon from '@/images/icons/trendGreen.svg';
// import trendRed from '@/images/icons/trendRed.svg';
...
//             <div className="grid grid-cols-3 gap-4 rounded-xl border border-borderColor p-5">
//                 <div>
