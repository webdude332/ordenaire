...
export default function Badge({
    ...
    const styles: Record<BadgeVariant, string> = {
        success: 'bg-[#ECFDF3] border-[#ABEFC6] text-[#067647]', // active
        warning: 'bg-[#FEF6EE] border-[#F9DBAF] text-[#B93815]', // warning
        error: 'bg-[#FEF3F2] border-[#FECDCA] text-[#B42318]', // danger
        blue: 'bg-[#EFF8FF] border-[#B2DDFF] text-[#175CD3]', // (Pro Plan)
        purple: 'bg-[#F4F3FF] border-[#D9D6FE] text-[#5925DC]', // (Enterprise)
        gray: 'bg-[#F9F7FA] border-[#E8E6EA] text-[#696170]', // (Standard)
        active: 'bg-white border-[#CFCBD2] text-gray-500', // active
        inactive: 'bg-white border-[#CFCBD2] text-gray-500', // inactive
        archived: 'bg-white border-[#CFCBD2] text-gray-500', // archive
        failed: 'bg-white border-[#CFCBD2] text-gray-500', // failed
        // ─── STATUS STYLES (White BG, Gray Border, Dark Text) ───
        'status-blue': 'bg-white border-gray-300 text-gray-700',
        'status-orange': 'bg-white border-gray-300 text-gray-700',
        'status-gray': 'bg-white border-gray-300 text-gray-700',
        'status-success': 'bg-white border-gray-300 text-gray-700',
    };
    ...
    const dotStyles: Record<BadgeVariant, string> = {
        ...
        failed: 'bg-[#F04438]',
        // ─── STATUS DOT COLORS ───
        'status-blue': 'bg-[#2E90FA]', // Blue for In Progress
        'status-orange': 'bg-[#F79009]', // Orange for Pending
        'status-gray': 'bg-[#9C94A3]', // Gray for Open/Closed
        'status-success': 'bg-[#17B26A]', // Green for Resolved
    };
