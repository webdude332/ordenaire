...
// import PlusIcon from '@/images/icons/plus.svg?react'; // Assuming you have a plus icon, or use text
...
// // Simple Badge Component for this page specific statuses
...
//                 isEnabled
//                     ? 'bg-[#EBF7D5] text-[#7AB621]'
//                     : 'bg-gray-100 text-gray-500'
//             }`}
//         >
//             <span
//                 className={`h-1.5 w-1.5 rounded-full ${
//                     isEnabled ? 'bg-[#7AB621]' : 'bg-gray-400'
//                 }`}
//             />
//             {status}
//         </span>
...
//                     <div className={` transition-transform duration-200 ${isAuditLogOpen ? 'rotate-180' : ''}`}>
//                          <ActionButton>
