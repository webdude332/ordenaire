                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="inline-flex overflow-hidden rounded-xl border border-gray-300">
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2 text-sm font-medium transition ${viewMode === 'list' ? 'bg-[#F8FFEB] text-[#578500]' : 'bg-white text-gray-500 hover:bg-gray-50'}`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2 text-sm font-medium transition ${viewMode === 'grid' ? 'bg-[#F8FFEB] text-[#578500]' : 'bg-white text-gray-500 hover:bg-gray-50'}`}
                        >
