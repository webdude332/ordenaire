...
//         <div>
//             {/* ── Sub-tabs + Search ─────────────────────────────────── */}
//             <div className="mb-5 flex items-center justify-between border-b border-gray-200"></div>
            ...
            <div className="rounded-xl border border-borderColor pt-6">
                <div className="flex items-center justify-between px-6 pb-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="flex w-44 items-center gap-1.5 rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-600 hover:bg-gray-50">
                            <Calendar className="h-4 w-4 text-gray-400" />
                            Date: All
                        </button>
                    </div>
