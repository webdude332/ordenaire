// import ViewChargeDiscount from '@/components/Modals/ViewChargeDiscount';
// import ViewRefundModal from '@/components/Modals/ViewRefundModal';
// import ViewSubscription from '@/components/Modals/ViewSubscription';
// import CircleTick from '@/images/icons/circleTick.svg?react';
// import CircleX from '@/images/icons/circleX.svg?react';
...
// export default function AllRequests({ search = '' }: AllRequestsProps) {
//     const [activeSubTab, setActiveSubTab] = useState<
//         'all' | 'subscriptions' | 'refunds' | 'discounts'
//     >('all');
...
//             (activeSubTab === 'refunds' && r.requestType === 'Refund') ||
...
//         { key: 'discounts' as const, label: 'Charge Discounts' },
//     ];
...
//             count: ALL_REQUESTS.filter(
//                 (r) => r.requestType === 'New Subscription',
//             ).length,
//         },
//         {
//             key: 'refunds' as const,
//             label: 'Refunds',
//             count: ALL_REQUESTS.filter((r) => r.requestType === 'Refund')
//                 .length,
//         },
//         {
...
//             count: ALL_REQUESTS.filter(
//                 (r) => r.requestType === 'Charge Discount',
//             ).length,
//         },
//     ];
...
//                 {/* ── Quick Filter Tabs ─────────────────────────────────── */}
//                 <div className="flex items-center gap-1 border-t border-gray-100 px-6 py-3">
//                     {subTabs.map((tab) => (
//                         <button
//                             key={tab.key}
