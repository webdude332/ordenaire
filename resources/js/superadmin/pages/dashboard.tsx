...
// import BtnLink from '../../shared/images/icons/colorLink.svg?react';
// import dashboardIcon from '../../shared/images/icons/dashBaordSvg.svg?react'; // Dashboard uses PNG
...
//                         <Button href="/superadmin/reports" className="font-medium">
...
export default function Dashboard() {
    return (
        <div className="flex h-screen overflow-hidden font-montserrat">
            ...
            <div className="custom-scrollbar no-scrollbar relative flex min-w-0 flex-1 flex-col overflow-x-hidden overflow-y-auto">
                <TopBar
                    title="Ordenaire Dashboard"
                    icon={dashboardIcon}
                    iconClassName="text-red-900"
