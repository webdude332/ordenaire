...
import LeftArrow from '../../shared/images/icons/backArrow.svg?react';
import Cafe from '../../shared/images/icons/cafeIcon.svg?react'; // Reuse cafe icon for logo placeholder
    ...
    const breadcrumbs = [
        {
            ...
            isActive: false,
            href: '/superadmin/business-management',
        },
        {
        ...
        <div className="flex min-h-screen">
            ...
            <main className="flex flex-1 flex-col">
                ...
                <div className="flex-1 px-8 py-6">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            ...
                            account. Invitations will be sent immediately.
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-12 gap-10 border-b border-[#E8E6EA] pb-8">
                            ...
                            <div className="col-span-9 rounded-xl border border-[#E8E6EA] bg-white p-6 shadow-xs">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <InfoRow
                                        label="Parent/ Branch"
                                        value={summaryData.parent}
                                    />
                                    <div className="my-4 h-px w-full bg-gray-100"></div>
                                    <InfoRow
                                        label="Address"
                                        value={summaryData.address}
                                    />
                                    <InfoRow
                                        label="Language"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-12 gap-4">
                                        ...
                                        <div className="col-span-8 flex gap-3">
                                            {summaryData.documents.map(
                                                (doc, idx) => (
                                                    <span
                                                        key={idx}
                                                        className="inline-flex items-center gap-1.5 rounded-md border border-[#B9E6FE] bg-[#F0F9FF] px-2.5 py-1 text-xs font-medium text-[#026AA2]"
                                                    >
                                                        <CheckCircle2 className="h-3.5 w-3.5 fill-[#F0F9FF] text-[#026AA2]" />
                                                        {doc}
                                                    </span>
                                                ),
                                            )}
                            ...
                            <div className="col-span-9 rounded-xl border border-[#E8E6EA] bg-white p-6 shadow-xs">
                                <div className="space-y-4">
                                    <InfoRow
                                        ...
                                        value={summaryData.serviceModels}
                                    />
                                    <InfoRow
                                        label="Modules Active"
                                        value={summaryData.modules}
                                    />
                                    <InfoRow
                                        label="Integrations"
                                        value={summaryData.integrations}
                                    />
                                    <InfoRow
                                        label="Hardware"
                                        value={summaryData.hardware}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-12 gap-10">
                            ...
                            <div className="col-span-9 rounded-xl border border-[#E8E6EA] bg-white p-6 shadow-xs">
                                <div className="space-y-4">
                                    <InfoRow
                                        label="Primary Admin"
                                        value={summaryData.primaryAdmin}
                                    />
                                    <InfoRow
                                        label="Additional Invites"
                                        value={summaryData.invites}
                                    />
                                </div>
                            </div>
                        </div>
                ...
                <div className="flex items-center justify-end gap-3 border-t border-gray-200 bg-white px-8 py-4">
                    <Link href="/business/team-access">
                        <IconButton className="border border-gray-300 bg-white text-gray-700 hover:bg-gray-50">
                            Back
                        </IconButton>
                    </Link>
                    <button className="flex items-center gap-2 rounded-lg bg-[#8CDD05] px-6 py-2 text-sm font-bold text-white shadow-sm hover:bg-[#7AB621]">
