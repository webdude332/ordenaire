...
// import Info from '../../shared/images/icons/gray-info.svg?react';
...
//                             <Link href="/superadmin/usermanagement?tab=roles">
...
const EditRole = () => {
    const [toastConfig, setToastConfig] = useState<ToastConfig | null>(null);
    const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false); // <-- Added state for Modal
    ...
    // <-- Changed to just open the modal
    const handleDeleteClick = () => {
        setIsDeleteModalOpen(true);
    };

    // <-- Added function to handle actual deletion from the modal
    const handleConfirmDelete = () => {
        ...
        // You can add your actual API delete call/redirect here
    };
        ...
        <div className="flex min-h-screen">
            ...
            <main className="flex flex-1 flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-8 py-6">
                    {/* Back Button */}
                    <div className="mb-8">
                        {/* <-- Updated href to point to the roles tab --> */}
                        <Link href="/superadmin/usermanagement?tab=roles">
                            <IconButton className="">
                                <BackArrow className="h-5 w-5 text-[#B5B0BA]" />
                                Back to Roles & Permissions
            ...
            {/* <-- Added DeleteModal Component Here --> */}
            <DeleteModal
            ...
            {toastConfig && (
                <SuccessToast
                    ...
                    actionText={toastConfig.actionText}
                    autoCloseDuration={2000}
                    redirectTo="/superadmin/usermanagement?tab=roles"
                />
            )}
        </div>
    );
