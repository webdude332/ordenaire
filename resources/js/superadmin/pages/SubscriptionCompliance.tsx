...
import CustomDropdown from '@/superadmin/components/ui/CustomDropdown'; // Reuse your dropdown
                            ...
                            <div className="col-span-9 space-y-6 rounded-xl border border-[#E8E6EA] bg-white p-6 shadow-xs">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="mt-2 text-xs text-gray-500">
                                        Note: If a discount is applied, it is
                                        valid only for the first billing cycle.
                                        Any future discounts must be applied
                                        again from the Billing section.
                                    </p>
                                </div>
                            </div>
                        </div>
