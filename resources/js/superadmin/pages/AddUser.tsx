...
import Profile from '@shared/images/icons/dp.svg?react';
...
import UpdateProfilePhotoModal from '@/superadmin/components/Modals/PhotoUploadModal';
                ...
                <div className="flex-1 overflow-y-auto px-8 py-6">
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center justify-end gap-4 border-t border-borderColor pt-4">
                            <Link className="/superadmin/usermanagement">
                                <IconButton
                                    type="button"
