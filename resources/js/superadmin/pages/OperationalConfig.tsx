                                ...
                                <div className="grid grid-cols-2 gap-4 rounded-lg border border-[#E8E6EA] p-6 shadow-xs">
                                    ...
                                    <button
                                        ...
                                        className={`flex h-[60px] items-center justify-center gap-3 rounded-lg border text-sm font-medium transition-colors ${
                                            formData.dineIn
                                                ? 'border-[#8CDD05] bg-[#F8FFEB] text-gray-900'
                        ...
                        <div className="grid grid-cols-12 gap-10 border-b border-[#E8E6EA] pb-10">
                            ...
                            <div className="col-span-9 space-y-6 rounded-xl border border-[#E8E6EA] bg-white p-6 shadow-xs">
                                ...
                                <div>
                                    ...
                                    <Toggle
                                        checked={formData.kds}
                                        onChange={() =>
                                            updateForm('kds', !formData.kds)
                                        }
                                    />
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <p className="mt-1 text-xs text-gray-500">
                                            ...
                                            terminals beyond the plan limit.
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        />
                                        <p className="mt-1 text-xs text-gray-500">
                                            Additional charges apply for Kiosk
                                            Machines beyond the plan limit.
                                        </p>
                                    </div>
                                </div>
                            </div>
