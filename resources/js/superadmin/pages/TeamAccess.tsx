                                    ...
                                    <tbody className="divide-y divide-gray-200 bg-white">
                                        {inviteList.map((user) => (
                                            <tr key={user.id}>
                                                ...
                                                <td className="px-6 py-4">
                                                    <span
                                                        className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium ${user.roleColor} ${user.roleColor.includes('border') ? '' : 'border-transparent'}`}
                                                    >
                                                        <div
