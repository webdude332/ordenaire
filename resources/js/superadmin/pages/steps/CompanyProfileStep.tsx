...
import SearchableDropdown from '@/superadmin/components/ui/SearchableDropdown';
import ToggleSwitch from '@/superadmin/components/ui/ToggleSwitch';
import UploadDocumentModal from '@/superadmin/components/UploadDocumentModal';
import { Link } from '@inertiajs/react';
import Uae from '@shared/images/icons/ae.svg?react';
import BusinessProfileIcon from '@shared/images/icons/businessProfile.svg?react';
            ...
            <div className="space-y-8 border-t border-gray-200 pt-8">
                ...
                {!isEditMode && (
                    <div className="flex items-center justify-end gap-3 border-t border-gray-200 pt-6">
                        <Link href="/superadmin/business-management">
