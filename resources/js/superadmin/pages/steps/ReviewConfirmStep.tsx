...
// import Tick from '../../../shared/images/icons/checkIcon.svg?react';
// // Added icons for the modal
// import ModalTick from '@shared/images/icons/modalTick.svg?react';
...
import BusinessRegistrationSuccessModal from '@/superadmin/components/BusinessSuccessModal';
import Button from '@/superadmin/components/ui/Button';
import IconButton from '@/superadmin/components/ui/IconButton';
import { router } from '@inertiajs/react';
import Cafe from '@shared/images/icons/cafeIcon.svg?react';
...
const ReviewConfirmStep = ({ data, onBack, onSubmit }: StepProps) => {
    ...
    return (
        <div>
            ...
            <BusinessRegistrationSuccessModal
                isOpen={showSuccessModal}
                onClose={handleCloseModal}
                businessName={data.legalName || 'Tea Time Jumeirah'}
                onViewProfile={handleGoToDashboard}
            />
        </div>
    );
};
