// import Edit from '@shared/images/icons/editIcon.svg?react';
// import Eye from '@shared/images/icons/eyeIcon.svg?react';
// import Profile from '@shared/images/icons/teaProfile.svg?react';
...
import Eye from '@shared/images/icons/eyeIcon.svg?react';
import Profile from '@shared/images/icons/teaProfile.svg?react';
import UsaIcon from '@shared/images/icons/us.svg?react';
// Import your flag SVGs here
import Uae from '@shared/images/icons/ae.svg?react';
import AusIcon from '@shared/images/icons/aus.svg?react';
import Kwd from '@shared/images/icons/kw.svg?react';

// Maps to connect string values to their respective SVG components
...
const langIcons: Record<string, any> = {
    Arabic: Uae,
    English: UsaIcon, // Assuming you want to use the UAE flag for Arabic
    // English: UsaIcon, // You can import and add an English/US flag here later
};
...
const BusinessProfileHeader = ({
    ...
    // Dynamically grab the correct icons based on the passed props
    const CountryIcon = countryIcons[country];
    const LangIcon = langIcons[preferredLanguage];
            ...
            <div className="mt-8 rounded-xl border border-[#E8E6EA] bg-[#F8FFEB] px-6 pt-6 pb-6">
                ...
                <div className="grid grid-cols-4 pt-6">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-sm font-medium text-gray-900">
                            {LangIcon ? (
                                <LangIcon className="h-5 w-5 shrink-0" />
                            ) : (
                ...
                <div className="grid grid-cols-4 border-b border-[#8CDD05] py-6">
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-sm font-medium text-gray-900">
                            {CountryIcon ? (
                                <CountryIcon className="h-5 w-5 shrink-0" />
                            ) : (
                                <div className="h-5 w-5 shrink-0 rounded-full bg-gray-200"></div>
                            )}
                            <span>{country}</span>
