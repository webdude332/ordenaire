...
import patternBg from '../../shared/images/icons/patternBg.svg'; // Ensure this path is correct
import SparkleIcon from '../../shared/images/icons/stars.svg?react';
...
export default function AddNewFeatureModal({
    isOpen,
    onClose,
    onSave,
}: AddNewFeatureModalProps) {
    // --- State Management ---
  ...
  `);
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} maxWidth="4xl">
            {/* Main Wrapper matching Reference */}
                            ...
                            <div className="mb-5 grid grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <CustomDropdown
                                        ...
                                        value={feature}
                                        onChange={setFeature}
                                        placeholder="All features from backbend"
                                    />
                                </div>
                                <div>
