...
// Icons
import BetaIcon from '@shared/images/icons/betaIcon.svg?react';
import patternBg from '@shared/images/icons/patternBg.svg'; // Use your pattern path
...
export default function AssignBetaModal({
    isOpen,
    onClose,
    onSave,
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <CustomDropdown
                                        ...
                                        placeholder="All features from backend"
                                    />
                                </div>
                                <div>
