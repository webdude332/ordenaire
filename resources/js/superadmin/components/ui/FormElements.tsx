import checkIcon from '@shared/images/icons/checkIcon.svg';
...
export const Checkbox = ({
    ...
    return (
        <label
            className={`group flex cursor-pointer items-center gap-2 text-sm ${disabled ? 'cursor-not-allowed opacity-50' : 'text-gray-700'}`}
        >
            <input
                type="checkbox"
            ...
            />
            <div
                className={`flex h-5 w-5 items-center justify-center rounded border transition-all peer-checked:border-[#79B800] peer-checked:bg-[#79B800] [&_img]:hidden peer-checked:[&_img]:block [&_svg]:hidden peer-checked:[&_svg]:block ${
                    disabled
