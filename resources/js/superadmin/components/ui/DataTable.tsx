...
import Upload from '@shared/images/icons/upload.svg?react';
                    ...
                    {documents.map((doc, idx) => (
                        <tr key={idx} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 text-sm">
                                ...
                                doc.fileName ? (
                                    <span className="inline-flex items-center gap-2 rounded-lg border border-green-200 bg-[#ECFDF3] px-2 py-1 text-xs font-medium text-[#067647]">
                                        <span className="h-1.5 w-1.5 rounded-full bg-[#17B26A]"></span>
                                        {doc.fileName}
                                    </span>
                                ) : (
                                    <span className="inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-gray-100 px-1.5 py-1 text-xs text-gray-500">
