...
// import Complete from '@shared/images/icons/complete.svg?react';
// import TrashIcon from '@shared/images/icons/delIcon.svg?react';
// import Failed from '@shared/images/icons/failed.svg?react';
// import FilePlusIcon from '@shared/images/icons/filePlus.svg?react';
...
export default function AddDocumentModal({
    ...
    onClose,
    onAdd,
    title = 'Add Document', // Default fallback value
    submitButtonText = 'Add Document', // Default fallback value
}: AddDocumentModalProps) {
    // --- State Management --
    const [uploadStatus, setUploadStatus] = useState<UploadStatus>('initial');
    const [progress, setProgress] = useState(0);
            ...
            <div className="mt-2 flex gap-4 border-t border-gray-100 bg-white px-8 py-5">
                ...
                <div className="flex-1">
                    <Button
                        ...
                        disabled={uploadStatus !== 'success'}
                    >
                        {/* 3. Made Button Text Dynamic Here */}
                        {submitButtonText}
                    </Button>
                </div>
            </div>
