...
import AddWebhook from '@/superadmin/components/Modals/AddWebhook';
import DeleteAccessKey from '@/superadmin/components/Modals/DeleteAccessKey';
import EditWebhook from '@/superadmin/components/Modals/EditWebhook';
import GenerateKey from '@/superadmin/components/Modals/GenerateKey';
import RestoreKey from '@/superadmin/components/Modals/RestoreKey';
import RevokeKey from '@/superadmin/components/Modals/RevokeKey';
import SuccessKeyGeneration from '@/superadmin/components/Modals/SuccessKeyGeneration';
...
export default function ApiMgmt() {
    ...
    const handleRestore = (token: Token) => {
        setSelectedToken(token);
    ...
    const handleEditWebhook = (wh: Webhook) => {
        setSelectedWebhook(wh);
        setIsEditWebhookOpen(true);
    };

    // ── Webhook delete from edit modal ────────────────────────────────────────
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Generate Key → then show Success */}
            <GenerateKey
                isOpen={isGenerateOpen}
                onClose={() => setIsGenerateOpen(false)}
                onConfirm={handleGenerateKey}
            />
            <SuccessKeyGeneration
            ...
            <AddWebhook
                ...
                onConfirm={() => setIsAddWebhookOpen(false)}
            />
