...
import CloudIcon from '@shared/images/icons/cloudIcon.svg?react';
import UploadPlus from '@shared/images/icons/filePlus.svg?react';
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="h-11 w-full rounded-lg border border-gray-200 px-4 text-sm font-medium text-gray-900 transition-all focus:border-transparent focus:ring-2 focus:ring-lime-500 focus:outline-none"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="h-11 w-full rounded-lg border border-gray-200 pr-4 pl-10 text-sm font-medium text-gray-900 transition-all focus:border-transparent focus:ring-2 focus:ring-lime-500 focus:outline-none"
                                />
                            </div>
                        </div>
                    </div>
