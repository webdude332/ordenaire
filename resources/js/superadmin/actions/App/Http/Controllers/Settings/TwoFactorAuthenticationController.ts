...
* @see app/Http/Controllers/superadmin/settings/TwoFactorAuthenticationController.php:28
* @route '/superadmin/settings/two-factor'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/superadmin/settings/two-factor',
