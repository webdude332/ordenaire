...
* @see app/Http/Controllers/superadmin/settings/PasswordController.php:17
* @route '/superadmin/settings/password'
*/
...
* @see app/Http/Controllers/superadmin/settings/PasswordController.php:25
* @route '/superadmin/settings/password'
*/
